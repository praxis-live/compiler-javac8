...
package org.praxislive.compiler.tools.javac.processing;
...
import org.praxislive.compiler.source.util.TaskEvent;
import org.praxislive.compiler.tools.javac.api.BasicJavacTask;
import org.praxislive.compiler.tools.javac.api.JavacTrees;
import org.praxislive.compiler.tools.javac.api.MultiTaskListener;
import org.praxislive.compiler.tools.javac.code.*;
import org.praxislive.compiler.tools.javac.code.Symbol.*;
import org.praxislive.compiler.tools.javac.file.FSInfo;
import org.praxislive.compiler.tools.javac.file.JavacFileManager;
import org.praxislive.compiler.tools.javac.jvm.*;
import org.praxislive.compiler.tools.javac.jvm.ClassReader.BadClassFile;
import org.praxislive.compiler.tools.javac.main.JavaCompiler;
import org.praxislive.compiler.tools.javac.model.JavacElements;
import org.praxislive.compiler.tools.javac.model.JavacTypes;
import org.praxislive.compiler.tools.javac.parser.*;
...
import org.praxislive.compiler.tools.javac.util.ClientCodeException;
import org.praxislive.compiler.tools.javac.util.Context;
import org.praxislive.compiler.tools.javac.util.Convert;
import org.praxislive.compiler.tools.javac.util.JCDiagnostic;
import org.praxislive.compiler.tools.javac.util.JavacMessages;
...
import org.praxislive.compiler.tools.javac.util.ServiceLoader;
import static org.praxislive.compiler.tools.javac.code.Lint.LintCategory.PROCESSING;
import static org.praxislive.compiler.tools.javac.main.Option.*;
import static org.praxislive.compiler.tools.javac.comp.CompileStates.CompileState;
import static org.praxislive.compiler.tools.javac.util.JCDiagnostic.DiagnosticFlag.*;
