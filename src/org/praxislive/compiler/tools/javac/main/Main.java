...
import org.praxislive.compiler.source.util.Plugin;
import org.praxislive.compiler.tools.doclint.DocLint;
import org.praxislive.compiler.tools.javac.api.BasicJavacTask;
import org.praxislive.compiler.tools.javac.code.Source;
import org.praxislive.compiler.tools.javac.file.CacheFSInfo;
import org.praxislive.compiler.tools.javac.file.JavacFileManager;
import org.praxislive.compiler.tools.javac.jvm.Profile;
import org.praxislive.compiler.tools.javac.jvm.Target;
import org.praxislive.compiler.tools.javac.processing.AnnotationProcessingError;
...
import org.praxislive.compiler.tools.javac.util.Log.PrefixKind;
    ...
    public Collection<File> processArgs(String[] flags, String[] classNames) { // XXX sb protected
        ...
        if (showClass != null) {
            if (showClass.equals("showClass")) // no value given for option
                showClass = "org.praxislive.compiler.tools.javac.Main";
            showClass(showClass);
        }
...
//    }
    ...
    public static final String javacBundleName =
        "org.praxislive.compiler.tools.javac.resources.javac";
//
