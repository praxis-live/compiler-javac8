...
package org.praxislive.compiler.tools.javac.comp;

import org.praxislive.compiler.source.tree.MemberReferenceTree.ReferenceMode;
import org.praxislive.compiler.tools.javac.api.Formattable.LocalizedString;
import org.praxislive.compiler.tools.javac.code.*;
import org.praxislive.compiler.tools.javac.code.Symbol.*;
import org.praxislive.compiler.tools.javac.code.Type.*;
import org.praxislive.compiler.tools.javac.comp.Attr.ResultInfo;
import org.praxislive.compiler.tools.javac.comp.Check.CheckContext;
import org.praxislive.compiler.tools.javac.comp.DeferredAttr.AttrMode;
import org.praxislive.compiler.tools.javac.comp.DeferredAttr.DeferredAttrContext;
import org.praxislive.compiler.tools.javac.comp.DeferredAttr.DeferredType;
import org.praxislive.compiler.tools.javac.comp.Infer.InferenceContext;
import org.praxislive.compiler.tools.javac.comp.Infer.FreeTypeListener;
import org.praxislive.compiler.tools.javac.comp.Resolve.MethodResolutionContext.Candidate;
import org.praxislive.compiler.tools.javac.comp.Resolve.MethodResolutionDiagHelper.DiagnosticRewriter;
import org.praxislive.compiler.tools.javac.comp.Resolve.MethodResolutionDiagHelper.Template;
import org.praxislive.compiler.tools.javac.jvm.*;
import org.praxislive.compiler.tools.javac.main.Option;
import org.praxislive.compiler.tools.javac.tree.*;
import org.praxislive.compiler.tools.javac.tree.JCTree.*;
import org.praxislive.compiler.tools.javac.tree.JCTree.JCMemberReference.ReferenceKind;
import org.praxislive.compiler.tools.javac.tree.JCTree.JCPolyExpression.*;
import org.praxislive.compiler.tools.javac.util.*;
import org.praxislive.compiler.tools.javac.util.JCDiagnostic.DiagnosticFlag;
import org.praxislive.compiler.tools.javac.util.JCDiagnostic.DiagnosticPosition;
import org.praxislive.compiler.tools.javac.util.JCDiagnostic.DiagnosticType;
...
import static org.praxislive.compiler.tools.javac.code.Flags.*;
import static org.praxislive.compiler.tools.javac.code.Flags.BLOCK;
import static org.praxislive.compiler.tools.javac.code.Kinds.*;
import static org.praxislive.compiler.tools.javac.code.Kinds.ERRONEOUS;
import static org.praxislive.compiler.tools.javac.code.TypeTag.*;
import static org.praxislive.compiler.tools.javac.comp.Resolve.MethodResolutionPhase.*;
import static org.praxislive.compiler.tools.javac.tree.JCTree.Tag.*;
