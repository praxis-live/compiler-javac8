...
import org.praxislive.compiler.source.tree.IdentifierTree;
import org.praxislive.compiler.source.tree.MemberReferenceTree.ReferenceMode;
import org.praxislive.compiler.source.tree.MemberSelectTree;
import org.praxislive.compiler.source.tree.TreeVisitor;
import org.praxislive.compiler.source.util.SimpleTreeVisitor;
import org.praxislive.compiler.tools.javac.code.*;
import org.praxislive.compiler.tools.javac.code.Lint.LintCategory;
...
import static org.praxislive.compiler.tools.javac.code.Flags.ANNOTATION;
...
import static org.praxislive.compiler.tools.javac.code.TypeTag.WILDCARD;
...
//                             Resolve.isStatic(env));//DEBUG
    ...
    private final class TypeAnnotationsValidator extends TreeScanner {
         ...
         * org.praxislive.compiler.tools.javac.comp.Check.Validator.visitSelectInternal(JCFieldAccess)
