...
package org.praxislive.compiler.tools.javac;
...
public class Main {
    ...
    public static int compile(String[] args) {
        org.praxislive.compiler.tools.javac.main.Main compiler =
            new org.praxislive.compiler.tools.javac.main.Main("javac");
    ...
    public static int compile(String[] args, PrintWriter out) {
        org.praxislive.compiler.tools.javac.main.Main compiler =
            new org.praxislive.compiler.tools.javac.main.Main("javac", out);
        return compiler.compile(args).exitCode;
    }
}
