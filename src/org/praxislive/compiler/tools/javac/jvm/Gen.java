...
package org.praxislive.compiler.tools.javac.jvm;
...
import org.praxislive.compiler.tools.javac.comp.*;
...
import org.praxislive.compiler.tools.javac.jvm.Code.*;
import org.praxislive.compiler.tools.javac.jvm.Items.*;
...
import static org.praxislive.compiler.tools.javac.jvm.ByteCodes.*;
import static org.praxislive.compiler.tools.javac.jvm.CRTFlags.*;
 ...
 *************************************************************************/
    ...
    private void setTypeAnnotationPositions(int treePos) {
        ...
        for (Symbol s : new org.praxislive.compiler.tools.javac.model.FilteredMemberList(clazz.members())) {
