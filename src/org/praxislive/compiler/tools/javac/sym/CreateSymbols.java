...
package org.praxislive.compiler.tools.javac.sym;

import org.praxislive.compiler.tools.javac.api.JavacTaskImpl;
import org.praxislive.compiler.tools.javac.code.Kinds;
import org.praxislive.compiler.tools.javac.code.Scope;
import org.praxislive.compiler.tools.javac.code.Symbol.*;
import org.praxislive.compiler.tools.javac.code.Symbol;
import org.praxislive.compiler.tools.javac.code.Attribute;
import org.praxislive.compiler.tools.javac.code.Symtab;
import org.praxislive.compiler.tools.javac.code.Type;
import org.praxislive.compiler.tools.javac.code.Types;
import org.praxislive.compiler.tools.javac.jvm.ClassWriter;
import org.praxislive.compiler.tools.javac.jvm.Pool;
 ...
 *
 * <dl>
 * <dt>org.praxislive.compiler.tools.javac.sym.Jar</dt>
 * <dd>Specifies the location of rt.jar.</dd>
 * <dt>org.praxislive.compiler.tools.javac.sym.Dest</dt>
 ...
 */
@SupportedOptions({
    "org.praxislive.compiler.tools.javac.sym.Jar",
    "org.praxislive.compiler.tools.javac.sym.Dest",
    "org.praxislive.compiler.tools.javac.sym.Profiles"})
@SupportedAnnotationTypes("*")
public class CreateSymbols extends AbstractProcessor {

    static Set<String> getLegacyPackages() {
        ResourceBundle legacyBundle
            = ResourceBundle.getBundle("org.praxislive.compiler.tools.javac.resources.legacy");
    ...
    void createSymbols() throws IOException {
        ...
        String jarName = pOptions.get("org.praxislive.compiler.tools.javac.sym.Jar");
        if (jarName == null)
            throw new RuntimeException("Must use -Aorg.praxislive.compiler.tools.javac.sym.Jar=LOCATION_OF_JAR");
        String destName = pOptions.get("org.praxislive.compiler.tools.javac.sym.Dest");
        if (destName == null)
            throw new RuntimeException("Must use -Aorg.praxislive.compiler.tools.javac.sym.Dest=LOCATION_OF_JAR");
        String profileSpec=pOptions.get("org.praxislive.compiler.tools.javac.sym.Profiles");
        if (profileSpec == null)
            throw new RuntimeException("Must use -Aorg.praxislive.compiler.tools.javac.sym.Profiles=PROFILES_SPEC");
        ...
        org.praxislive.compiler.tools.javac.main.JavaCompiler compiler =
            org.praxislive.compiler.tools.javac.main.JavaCompiler.instance(task.getContext());
    ...
    public static void main(String... args) {
        ...
        args = new String[] {
            ...
            "-proc:only",
            "-processor",
            "org.praxislive.compiler.tools.javac.sym.CreateSymbols",
            "-Aorg.praxislive.compiler.tools.javac.sym.Jar=" + rt_jar,
            "-Aorg.praxislive.compiler.tools.javac.sym.Dest=" + dest,
            ...
            "org.xml.sax.ext",
            "org.xml.sax.helpers",
            "org.praxislive.compiler.java.browser.dom",
            "org.w3c.dom",
            "org.w3c.dom.bootstrap",
            "org.w3c.dom.ls",
            "org.w3c.dom.ranges",
            ...
            "org.w3c.dom.events",
            "org.w3c.dom.views",
            "org.praxislive.compiler.management",
            "org.praxislive.compiler.security.auth",
            "org.praxislive.compiler.security.auth.callback",
            "org.praxislive.compiler.security.auth.login",
            "org.praxislive.compiler.security.auth.module",
            "org.praxislive.compiler.security.jgss",
            "org.praxislive.compiler.net.httpserver",
            "org.praxislive.compiler.net.httpserver.spi",
            "javax.smartcardio"
            // </editor-fold>
        };
        org.praxislive.compiler.tools.javac.Main.compile(args);
    }
