...
*/
// Code duplicated in org.praxislive.compiler.tools.classfile.TypeAnnotation.Position
public class TypeAnnotationPosition {
    ...
    // In org.praxislive.compiler.tools.javac.jvm.Gen.genCatch we first set the type_index
    // to the catch type index - that value is only temporary.
    // Then in org.praxislive.compiler.tools.javac.jvm.Code.fillExceptionParameterPositions
