...
package org.praxislive.compiler.tools.javac.code;
...
import org.praxislive.compiler.tools.javac.code.Attribute.TypeCompound;
import org.praxislive.compiler.tools.javac.code.Type.AnnotatedType;
import org.praxislive.compiler.tools.javac.code.Type.ArrayType;
import org.praxislive.compiler.tools.javac.code.Type.CapturedType;
...
import org.praxislive.compiler.tools.javac.code.Type.ForAll;
import org.praxislive.compiler.tools.javac.code.Type.MethodType;
import org.praxislive.compiler.tools.javac.code.Type.PackageType;
import org.praxislive.compiler.tools.javac.code.Type.TypeVar;
import org.praxislive.compiler.tools.javac.code.Type.UndetVar;
import org.praxislive.compiler.tools.javac.code.Type.Visitor;
import org.praxislive.compiler.tools.javac.code.Type.WildcardType;
import org.praxislive.compiler.tools.javac.code.TypeAnnotationPosition.TypePathEntry;
import org.praxislive.compiler.tools.javac.code.TypeAnnotationPosition.TypePathEntryKind;
...
import org.praxislive.compiler.tools.javac.comp.Annotate;
import org.praxislive.compiler.tools.javac.comp.Annotate.Worker;
...
import org.praxislive.compiler.tools.javac.tree.JCTree.JCBlock;
import org.praxislive.compiler.tools.javac.tree.JCTree.JCClassDecl;
import org.praxislive.compiler.tools.javac.tree.JCTree.JCExpression;
import org.praxislive.compiler.tools.javac.tree.JCTree.JCLambda;
import org.praxislive.compiler.tools.javac.tree.JCTree.JCMethodDecl;
import org.praxislive.compiler.tools.javac.tree.JCTree.JCMethodInvocation;
import org.praxislive.compiler.tools.javac.tree.JCTree.JCNewClass;
import org.praxislive.compiler.tools.javac.tree.JCTree.JCTypeApply;
import org.praxislive.compiler.tools.javac.tree.JCTree.JCVariableDecl;
import org.praxislive.compiler.tools.javac.tree.TreeScanner;
import org.praxislive.compiler.tools.javac.tree.JCTree.*;
...
import org.praxislive.compiler.tools.javac.util.Options;
...
public class TypeAnnotations {
    ...
    private class TypeAnnotationPositions extends TreeScanner {
        ...
        // {@link org.praxislive.compiler.tools.javac.parser.JavacParser.insertAnnotationsToMostInner(JCExpression, List<JCTypeAnnotation>, boolean)}
        ...
        private Type typeWithAnnotations(final JCTree typetree, final Type type,
            ...
            if (type.hasTag(TypeTag.ARRAY)) {
                ...
                // UnionClassType uct = (org.praxislive.compiler.tools.javac.code.Type.UnionClassType)type;
        ...
        private void resolveFrame(JCTree tree, JCTree frame,
            ...
            */
            ...
            // org.praxislive.compiler.tools.javac.jvm.Gen.setTypeAnnotationPositions(int)
