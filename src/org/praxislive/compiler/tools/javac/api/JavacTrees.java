...
package org.praxislive.compiler.tools.javac.api;
...
import org.praxislive.compiler.source.doctree.DocCommentTree;
import org.praxislive.compiler.source.doctree.DocTree;
import org.praxislive.compiler.source.tree.CatchTree;
import org.praxislive.compiler.source.tree.CompilationUnitTree;
import org.praxislive.compiler.source.tree.Scope;
import org.praxislive.compiler.source.tree.Tree;
import org.praxislive.compiler.source.util.DocSourcePositions;
import org.praxislive.compiler.source.util.DocTreePath;
import org.praxislive.compiler.source.util.DocTreeScanner;
import org.praxislive.compiler.source.util.DocTrees;
import org.praxislive.compiler.source.util.JavacTask;
import org.praxislive.compiler.source.util.TreePath;
import org.praxislive.compiler.tools.javac.code.Flags;
import org.praxislive.compiler.tools.javac.code.Kinds;
import org.praxislive.compiler.tools.javac.code.Symbol;
import org.praxislive.compiler.tools.javac.code.Symbol.ClassSymbol;
import org.praxislive.compiler.tools.javac.code.Symbol.MethodSymbol;
import org.praxislive.compiler.tools.javac.code.Symbol.PackageSymbol;
import org.praxislive.compiler.tools.javac.code.Symbol.TypeSymbol;
import org.praxislive.compiler.tools.javac.code.Symbol.VarSymbol;
import org.praxislive.compiler.tools.javac.code.Type;
import org.praxislive.compiler.tools.javac.code.Type.ArrayType;
import org.praxislive.compiler.tools.javac.code.Type.ClassType;
import org.praxislive.compiler.tools.javac.code.Type.ErrorType;
import org.praxislive.compiler.tools.javac.code.Type.UnionClassType;
import org.praxislive.compiler.tools.javac.code.Types;
import org.praxislive.compiler.tools.javac.code.Types.TypeRelation;
import org.praxislive.compiler.tools.javac.comp.Attr;
import org.praxislive.compiler.tools.javac.comp.AttrContext;
import org.praxislive.compiler.tools.javac.comp.Enter;
import org.praxislive.compiler.tools.javac.comp.Env;
import org.praxislive.compiler.tools.javac.comp.MemberEnter;
import org.praxislive.compiler.tools.javac.comp.Resolve;
import org.praxislive.compiler.tools.javac.model.JavacElements;
import org.praxislive.compiler.tools.javac.processing.JavacProcessingEnvironment;
import org.praxislive.compiler.tools.javac.tree.DCTree;
import org.praxislive.compiler.tools.javac.tree.DCTree.DCBlockTag;
import org.praxislive.compiler.tools.javac.tree.DCTree.DCDocComment;
import org.praxislive.compiler.tools.javac.tree.DCTree.DCEndPosTree;
import org.praxislive.compiler.tools.javac.tree.DCTree.DCErroneous;
import org.praxislive.compiler.tools.javac.tree.DCTree.DCIdentifier;
import org.praxislive.compiler.tools.javac.tree.DCTree.DCParam;
import org.praxislive.compiler.tools.javac.tree.DCTree.DCReference;
import org.praxislive.compiler.tools.javac.tree.DCTree.DCText;
import org.praxislive.compiler.tools.javac.tree.EndPosTable;
import org.praxislive.compiler.tools.javac.tree.JCTree;
import org.praxislive.compiler.tools.javac.tree.JCTree.*;
import org.praxislive.compiler.tools.javac.tree.TreeCopier;
import org.praxislive.compiler.tools.javac.tree.TreeInfo;
import org.praxislive.compiler.tools.javac.tree.TreeMaker;
import org.praxislive.compiler.tools.javac.util.Abort;
import org.praxislive.compiler.tools.javac.util.Assert;
import org.praxislive.compiler.tools.javac.util.Context;
import org.praxislive.compiler.tools.javac.util.JCDiagnostic;
import org.praxislive.compiler.tools.javac.util.List;
import org.praxislive.compiler.tools.javac.util.ListBuffer;
import org.praxislive.compiler.tools.javac.util.Log;
import org.praxislive.compiler.tools.javac.util.Name;
import org.praxislive.compiler.tools.javac.util.Names;
import org.praxislive.compiler.tools.javac.util.Pair;
import org.praxislive.compiler.tools.javac.util.Position;
import static org.praxislive.compiler.tools.javac.code.TypeTag.*;
...
public class JavacTrees extends DocTrees {
    ...
    /** @see org.praxislive.compiler.tools.javadoc.ClassDocImpl#findField */
    private VarSymbol findField(ClassSymbol tsym, Name fieldName) {
        return searchField(tsym, fieldName, new HashSet<ClassSymbol>());
    }

    /** @see org.praxislive.compiler.tools.javadoc.ClassDocImpl#searchField */
    private VarSymbol searchField(ClassSymbol tsym, Name fieldName, Set<ClassSymbol> searched) {
        ...
        for (org.praxislive.compiler.tools.javac.code.Scope.Entry e = tsym.members().lookup(fieldName);
    ...
    /** @see org.praxislive.compiler.tools.javadoc.ClassDocImpl#findConstructor */
    MethodSymbol findConstructor(ClassSymbol tsym, List<Type> paramTypes) {
        for (org.praxislive.compiler.tools.javac.code.Scope.Entry e = tsym.members().lookup(names.init);
                e.scope != null; e = e.next()) {
    ...
    /** @see org.praxislive.compiler.tools.javadoc.ClassDocImpl#findMethod */
    ...
    /** @see org.praxislive.compiler.tools.javadoc.ClassDocImpl#searchMethod */
    private MethodSymbol searchMethod(ClassSymbol tsym, Name methodName,
        ...
        org.praxislive.compiler.tools.javac.code.Scope.Entry e = tsym.members().lookup(methodName);
    ...
    /** @see org.praxislive.compiler.tools.javadoc.ClassDocImpl */
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
        if (scope instanceof JavacScope
                ...
                && type instanceof org.praxislive.compiler.tools.javac.code.Type) {
            Env<AttrContext> env = ((JavacScope) scope).env;
            return resolve.isAccessible(env, (org.praxislive.compiler.tools.javac.code.Type)type, (Symbol)member, true);
        } else
            return false;
    }
...
//                    System.err.println("DEFAULT: " + tree.getKind());
    ...
    public TypeMirror getOriginalType(javax.lang.model.type.ErrorType errorType) {
        if (errorType instanceof org.praxislive.compiler.tools.javac.code.Type.ErrorType) {
            return ((org.praxislive.compiler.tools.javac.code.Type.ErrorType)errorType).getOriginalType();
        }

        return org.praxislive.compiler.tools.javac.code.Type.noType;
    }
    ...
    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
            org.praxislive.compiler.source.tree.Tree t,
            org.praxislive.compiler.source.tree.CompilationUnitTree root) {
        printMessage(kind, msg, ((JCTree) t).pos(), root);
    }

    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
            org.praxislive.compiler.source.doctree.DocTree t,
            org.praxislive.compiler.source.doctree.DocCommentTree c,
            org.praxislive.compiler.source.tree.CompilationUnitTree root) {
