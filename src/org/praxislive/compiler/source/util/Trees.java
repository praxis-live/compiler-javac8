...
package org.praxislive.compiler.source.util;
...
public abstract class Trees {
    ...
    public static Trees instance(CompilationTask task) {
        ...
        if (!taskClassName.equals("org.praxislive.compiler.tools.javac.api.JavacTaskImpl")
                && !taskClassName.equals("org.praxislive.compiler.tools.javac.api.BasicJavacTask"))
    ...
    public static Trees instance(ProcessingEnvironment env) {
        if (!env.getClass().getName().equals("org.praxislive.compiler.tools.javac.processing.JavacProcessingEnvironment"))
            throw new IllegalArgumentException();
    ...
    static Trees getJavacTrees(Class<?> argType, Object arg) {
        try {
            ...
            Class<?> c = Class.forName("org.praxislive.compiler.tools.javac.api.JavacTrees", false, cl);
