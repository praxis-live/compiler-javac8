...
public abstract class JavacTask implements CompilationTask {
    ...
    public static JavacTask instance(ProcessingEnvironment processingEnvironment) {
        if (!processingEnvironment.getClass().getName().equals(
                "org.praxislive.compiler.tools.javac.processing.JavacProcessingEnvironment"))
     ...
     * {@link org.praxislive.compiler.source.util.Trees Trees}.
     * @see org.praxislive.compiler.source.util.Trees#getTypeMirror
     */
